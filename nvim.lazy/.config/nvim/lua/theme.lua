...
function M.setup(spec)
  ...
  local function set_highlights()
    ...
    hl("LazyButton", { fg = fg, bg = surface })
    hl("LazyButtonActive", { fg = bg, bg = accent, bold = true })
    hl("WhichKey", { fg = accent })
    hl("WhichKeyGroup", { fg = blue })
    hl("WhichKeyDesc", { fg = fg })
    hl("TelescopeNormal", { fg = fg, bg = surface })
    hl("TelescopeBorder", { fg = accent, bg = surface })
    hl("TelescopeSelection", { fg = bg, bg = accent, bold = true })
    ...
    hl("SnacksPicker", { fg = fg, bg = surface })
    hl("SnacksPickerBorder", { fg = accent, bg = surface })
  end
